...
export interface JenkinsSpecMaster {
   ...
   *
   * @default name: kubernetes version: 1.29.6 - name: workflow-job version: "2.39" - name: workflow-aggregator version: "2.6" - name: git version: 4.7.2 - name: job-dsl version: "1.74" - name: configuration-as-code version: "1.51" - name: kubernetes-credentials-provider version: 0.18-1
